...
def main():
    ...
    EuRoC_data_folder = "/home/lilabws001/catkin_ws/src/aplvins/src/APL-VINS/analysis/data/euroc/"
    EuRoC_LSD_LBD_costs = getData(EuRoC_data_folder + "LSD_LBD_costs/")
    EuRoC_ED_LOFT_costs = getData(EuRoC_data_folder + "ED_LOFT_costs/")
    ...
    # box4 = ax.boxplot(EuRoC_ED_LOFT_costs, 
    #                   positions=x4,
    #                   showfliers=False,
    #                   patch_artist=True,
    #                   boxprops=dict(facecolor="#81B21F",
    ...
    TUMVI_data_folder = "/home/lilabws001/catkin_ws/src/aplvins/src/APL-VINS/analysis/data/tumvi/"
    TUMVI_LSD_LBD_costs = getData(TUMVI_data_folder + "LSD_LBD_costs/")
    TUMVI_ED_LOFT_costs = getData(TUMVI_data_folder + "ED_LOFT_costs/")
