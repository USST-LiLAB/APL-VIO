...
const Eigen::Vector3d CameraMarker::imlt = Eigen::Vector3d(-1.0, -0.5, 1.0);
const Eigen::Vector3d CameraMarker::imrt = Eigen::Vector3d( 1.0, -0.5, 1.0);
const Eigen::Vector3d CameraMarker::imlb = Eigen::Vector3d(-1.0,  0.5, 1.0);
const Eigen::Vector3d CameraMarker::imrb = Eigen::Vector3d( 1.0,  0.5, 1.0);
const Eigen::Vector3d CameraMarker::lt0 = Eigen::Vector3d(-0.7, -0.5, 1.0);
const Eigen::Vector3d CameraMarker::lt1 = Eigen::Vector3d(-0.7, -0.2, 1.0);
const Eigen::Vector3d CameraMarker::lt2 = Eigen::Vector3d(-1.0, -0.2, 1.0);
const Eigen::Vector3d CameraMarker::oc = Eigen::Vector3d(0.0, 0.0, 0.0);


void CameraMarker::Eigen2Point(const Eigen::Vector3d &v, geometry_msgs::Point &p)
{
    p.x = v.x();
    p.y = v.y();
    p.z = v.z();
...
CameraMarker::CameraMarker(float r, float g, float b, float a)
{
    setScale(0.25);
    setLineWidth(0.02);
...
void CameraMarker::createMarker(const Eigen::Vector3d &p, const Eigen::Quaterniond &q)
{
